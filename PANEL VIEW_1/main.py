...
class Ventana(Frame):
	...
	def widgets(self):
		self.imagen_inicio = PhotoImage(file ='C:/Users/angel/Documents/ABC ELECTRONICS/VSC-PROGRAMAS/PANEL_VIEW_1/inicio.png')
		self.imagen_menu = PhotoImage(file ='C:/Users/angel/Documents/ABC ELECTRONICS/VSC-PROGRAMAS/PANEL_VIEW_1/menu.png')
		self.imagen_datos = PhotoImage(file ='C:/Users/angel/Documents/ABC ELECTRONICS/VSC-PROGRAMAS/PANEL_VIEW_1/datos.png')
		self.imagen_registrar = PhotoImage(file ='C:/Users/angel/Documents/ABC ELECTRONICS/VSC-PROGRAMAS/PANEL_VIEW_1/escribir.png')
		self.imagen_actualizar = PhotoImage(file ='C:/Users/angel/Documents/ABC ELECTRONICS/VSC-PROGRAMAS/PANEL_VIEW_1/actualizar.png')
		self.imagen_buscar = PhotoImage(file ='C:/Users/angel/Documents/ABC ELECTRONICS/VSC-PROGRAMAS/PANEL_VIEW_1/buscar.png')
		self.imagen_ajustes = PhotoImage(file ='C:/Users/angel/Documents/ABC ELECTRONICS/VSC-PROGRAMAS/PANEL_VIEW_1/configuracion.png')

		self.logo = PhotoImage(file ='C:/Users/angel/Documents/ABC ELECTRONICS/VSC-PROGRAMAS/PANEL_VIEW_1/logo.png')
		self.imagen_uno = PhotoImage(file ='C:/Users/angel/Documents/ABC ELECTRONICS/VSC-PROGRAMAS/PANEL_VIEW_1/imagen_uno.png')
		self.imagen_dos= PhotoImage(file ='C:/Users/angel/Documents/ABC ELECTRONICS/VSC-PROGRAMAS/PANEL_VIEW_1/imagen_dos.png')
		self.dia = PhotoImage(file ='C:/Users/angel/Documents/ABC ELECTRONICS/VSC-PROGRAMAS/PANEL_VIEW_1/dia.png')
		self.noche= PhotoImage(file ='C:/Users/angel/Documents/ABC ELECTRONICS/VSC-PROGRAMAS/PANEL_VIEW_1/noche.png')
		...
		######################## FRAME TITULO #################
		self.titulo = Label(self.frame_top,text= 'APLICACION DE VISION COMPUTACIONAL', bg='black', fg= 'DarkOrchid1', font= ('Imprint MT Shadow', 15, 'bold'))
		self.titulo.pack(expand=1)

		######################## VENTANA PRINCIPAL #################

		Label(self.frame_uno, text= 'ABC TECHNOLOGIES', bg='DarkOrchid1', fg= 'white', font= ('Freehand521 BT', 20, 'bold')).pack(expand=1)
		...
		self.tabla_uno['columns'] = ('Nombre', 'Valor', 'NumberID', 'Fecha')
		...
		self.tabla_uno.column('Valor', minwidth=100, width=120, anchor='center' )
		self.tabla_uno.column('NumberID', minwidth=100, width=120 , anchor='center')
		self.tabla_uno.column('Fecha', minwidth=100, width=105, anchor='center')

		self.tabla_uno.heading('#0', text='ID', anchor ='center')
		self.tabla_uno.heading('Nombre', text='Nombre', anchor ='center')
		self.tabla_uno.heading('Valor', text='Valor', anchor ='center')
		self.tabla_uno.heading('NumberID', text='NumberID', anchor ='center')
		...
		Label(self.frame_tres, text = 'ID',fg='navy', bg ='white', font=('Rockwell',13,'bold')).grid(column=0,row=1, pady=15, padx=5)
		Label(self.frame_tres, text = 'Nombre',fg='navy', bg ='white', font=('Rockwell',13,'bold')).grid(column=0,row=2, pady=15)
		Label(self.frame_tres, text = 'Valor',fg='navy', bg ='white', font=('Rockwell',13,'bold')).grid(column=0,row=3, pady=15)
		Label(self.frame_tres, text = 'NumberID', fg='navy',bg ='white', font=('Rockwell',13,'bold')).grid(column=0,row=4, pady=15)
		Label(self.frame_tres, text = 'Fecha',fg='navy', bg ='white', font=('Rockwell',13,'bold')).grid(column=0,row=5, pady=15)  ##E65561
		...
		Label(self.frame_cuatro, text = 'ID',fg='navy', bg ='white', font=('Rockwell',13,'bold')).grid(column=0,row=2, pady=15, padx=10)
		Label(self.frame_cuatro, text = 'Nombre',fg='navy', bg ='white', font=('Rockwell',13,'bold')).grid(column=0,row=3, pady=15)
		Label(self.frame_cuatro, text = 'Valor',fg='navy', bg ='white', font=('Rockwell',13,'bold')).grid(column=0,row=4, pady=15)
		Label(self.frame_cuatro, text = 'NumberID', fg='navy',bg ='white', font=('Rockwell',13,'bold')).grid(column=0,row=5, pady=15)
		Label(self.frame_cuatro, text = 'Fecha',fg='navy', bg ='white', font=('Rockwell',13,'bold')).grid(column=0,row=6, pady=15)  ##E65561
		...
		self.tabla_dos['columns'] = ('Nombre', 'Valor', 'NumberID', 'Fecha')
		...
		self.tabla_dos.column('Valor', minwidth=100, width=120, anchor='center' )
		self.tabla_dos.column('NumberID', minwidth=100, width=120 , anchor='center')
		...
		self.tabla_dos.heading('Valor', text='Valor', anchor ='center')
		self.tabla_dos.heading('NumberID', text='NumberID', anchor ='center')
	...
	def datos_totales(self):
		...
		for dato in datos:
			i= i+1
			self.tabla_uno.insert('',i, text = datos[i][0:1], values=datos[i][1:6])
...
if __name__ == "__main__":
	...
	ventana.call('wm', 'iconphoto', ventana._w, PhotoImage(file='C:/Users/angel/Documents/ABC ELECTRONICS/VSC-PROGRAMAS/PANEL_VIEW_1/logo.png'))	
	app = Ventana(ventana)
	app.mainloop()
